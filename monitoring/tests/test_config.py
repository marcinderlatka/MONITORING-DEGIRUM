...
def test_preview_role_defaults_and_config_fill():
    ...
    assert updated["preview_main_max_width"] == 768
    assert updated["preview_main_max_height"] == 432
    assert updated["preview_grid_max_width"] == 512
    assert updated["preview_grid_max_height"] == 288
    assert updated["preview_thumb_max_width"] == 256
    assert updated["preview_thumb_max_height"] == 144
